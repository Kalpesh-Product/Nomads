...
const compSetupSupportPartnerSchema = new mongoose.Schema(
  {
...
compSetupSupportPartnerSchema.index(
  {
    normalizedCountry: 1,
...
const CompSetupSupportPartner = mongoose.model(
  "CompSetupSupportPartner",
  compSetupSupportPartnerSchema,
  "compSetupSupportPartners",
);

export default CompSetupSupportPartner;
