...
const workationSupportPartnerSchema = new mongoose.Schema(
  {
...
workationSupportPartnerSchema.index(
  {
    normalizedCountry: 1,
...
const WorkationSupportPartner = mongoose.model(
  "WorkationSupportPartner",
  workationSupportPartnerSchema,
  "workationSupportPartners",
);

export default WorkationSupportPartner;
