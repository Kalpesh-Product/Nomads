 ...
 * Only the hero copy, details rows, and "what happens next" items vary
 * per email type — everything else (top logo bar and bottom footer)
 * stays identical across templates.
 */
