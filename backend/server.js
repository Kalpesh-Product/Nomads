...
import consultationSupportRoutes from "./routes/consultationSupportRoutes.js";
import compSetupSupportRoutes from "./routes/compSetupSupportRoutes.js";
import activationSupportRoutes from "./routes/activationSupportRoutes.js";
import workationSupportRoutes from "./routes/workationSupportRoutes.js";
...
app.use("/api/consultation-support", consultationSupportRoutes);
app.use("/api/company-setup-support", compSetupSupportRoutes);
app.use("/api/activation-support", activationSupportRoutes);
app.use("/api/workation-support", workationSupportRoutes);
