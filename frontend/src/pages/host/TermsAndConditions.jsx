 ...
 const sections = [
  {
    ...
    content: (
      <>
        Welcome to WONOCO PRIVATE LIMITED (SINGAPORE COMPANY) ("Company", "we",
        "our", or "us"). These Terms and Conditions ("Terms") govern your use
        of our SaaS platform, located at{" "}
        <span
        ...
        <br />
        <br />
        By accessing or using the Service, you ("User", "you", or "your") agree
        to comply with and be bound by these Terms. If you do not agree with
        any part of these Terms, you must discontinue using the Service
        immediately.
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        unauthorized activity or if you breach these Terms.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        officers, employees, or agents shall not be liable for any indirect,
        incidental, special, or consequential damages arising from your use of
        the Service, including but not limited to loss of profits, data, or
        business opportunities.
        <br />
        In no event shall our total liability exceed the amount you paid to the
        Company for your use of the Service in the twelve (12) months preceding
        the claim.
      </>
    ),
  },
