...
const ClassicTemplateServiceDetailPage = () => {
      ...
      <section className="min-h-[50vh] bg-[#efefef] py-0">
        <Container>
          <div className="text-center">
            <h1 className="text-title font-semibold">Service Page Not Found</h1>
        ...
        <div className="absolute inset-0 z-10 flex items-end justify-center pb-10 md:pb-16">
          <div className="w-full text-center text-white">
            <h1 className="text-[26px] font-bold md:text-4xl">
              {page?.heroHeading || page?.name || "Service"}
            </h1>
            {page?.heroSubHeading ? (
...
export default ClassicTemplateServiceDetailPage;
