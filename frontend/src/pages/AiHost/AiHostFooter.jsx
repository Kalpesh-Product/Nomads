...
const AiFooter = () => {
  ...
  const goToHostsTC = () => {
    if (window.location.hostname.includes("localhost")) {
      window.location.href = "http://host.localhost:5173/terms-and-conditions";
    } else {
      window.location.href = "https://host.wono.co/terms-and-conditions";
    }
  };
  ...
  const goToHostsContentUseRemoval = () => {
    if (window.location.hostname.includes("localhost")) {
      window.location.href = "http://host.localhost:5173/content-use-removal";
    } else {
      window.location.href = "https://host.wono.co/content-use-removal";
    }
  };
