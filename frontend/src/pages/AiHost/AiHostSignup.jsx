      ...
      case 1:
        return (
          <>
            ...
            />
            <Box sx={{ display: "flex", gap: 2, width: "100%", mt: 0 }}>
              <Controller
                name="contactCode"
                control={control}
                render={({ field }) => (
                  <TextField
                    ...
                    fullWidth
                    variant="standard"
                    sx={{ ...compactStepFieldSx, maxWidth: 80 }}
                    InputLabelProps={{ sx: floatingLabelSx }}
                    InputProps={{
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <FormControl
                  ...
                  error={!!fieldState.error}
                >
                  <InputLabel sx={floatingLabelSx}>Type of Vertical</InputLabel>
                  <Select
                    multiple
                    name={field.name}
      ...
      >
        ...
        <form
          ...
          onSubmit={handleSubmit((values) => {
            ...
            fd.set(
              "mobile",
              [values.contactCode, values.mobile]
                .filter(Boolean)
                .join(" ")
                .trim() || "N/A",
            );
        ...
        >
          ...
          <div className="col-span-1 lg:col-span-2 grid grid-cols-1 items-center gap-4">
            ...
            <div className="flex justify-center">
              {activeStep !== 0 &&
              activeStep < activeFlowStepFields.length - 2 ? (
