      ...
      <Container padding={false}>
        <div className="flex px-4 lg:px-0 justify-between items-center md:py-3  ">
          ...
          <div className="px-1 hidden xl:flex xl:gap-4 py-2">
            ...
            <a
              href="https://wonofe.vercel.app"
              className="bg-[#FF5757] flex items-center justify-center text-white font-[500] capitalize hover:font-semibold hover:bg-red-400 w-[7rem] px-4 py-2 rounded-full">
              Login
            </a>
